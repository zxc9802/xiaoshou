...
function EmptyAdvice() {
  return <section className="advice-empty"><h2>回复建议将在这里生成</h2><p>完成对话输入后，AI将结合企业规则和已审核资料，优先提供推荐回复，并给出客户阶段、需求判断与下一步策略。</p><div><span>1</span>识别客户阶段<i /><span>2</span>定位沟通卡点<i /><span>3</span>生成回复建议</div></section>;
}
